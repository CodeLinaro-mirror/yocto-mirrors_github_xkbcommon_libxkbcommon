libxkbcommon [1.11.0] – 2025-08-07
==================================
...
[compatibility page] for detailed information of the feature of each format.
...
- `xkbcli how-to-type`: enable `--keymap` to load the keymap from a file or
  stdin instead of resolving RMLVO names.
